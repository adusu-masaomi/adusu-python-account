...
urlpatterns = [
    ...
    url('bank_select/', views.views.ajax_bank_branch_extract, name='bank_branch_extract'),   #ajax
    url('partner_sort/', views.views.ajax_partner_sort, name='partner_sort'),                #ajax
    # 勘定科目
    ...
    url('payment_sort/', views.views.ajax_payment_sort, name='payment_sort'),                #ajax
    url(r'^payment/report_1/$', views.payment_list_pdf.payment_list_1, name='payment_list_1'),    #支払集計表
]
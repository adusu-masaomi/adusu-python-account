...
class PartnerForm(forms.ModelForm):
    ...
    class Meta:
        model = Partner
        fields = ('administrative_name', 'name', 'trade_division_id', 'account_title', 'fixed_content_id', 'fixed_cost', 'rough_estimate', 'payment_method_id', 'bank', 'bank_branch', 'account_type', 'account_number', 'pay_day', 'pay_day_division',
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['account_type'].widget.attrs['tabindex'] = 10
        #口座番号
        self.fields['account_number'].widget.attrs['tabindex'] = 11
        
        #支払日
        self.fields['pay_day'].widget.attrs['style'] = 'width:70px; height:40px;'
        self.fields['pay_day'].widget.attrs['tabindex'] = 12
        
        #支払フラグ
        self.fields['pay_day_division'].widget.attrs['style'] = 'width:90px; height:40px;'
        self.fields['pay_day_division'].widget.attrs['tabindex'] = 13
...
class PaymentForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['payment_due_date'].widget.attrs['tabindex'] = 7
        ...
        self.fields['payment_date'].widget.attrs['tabindex'] = 8
        
        #備考
        self.fields['note'].widget.attrs['tabindex'] = 9
        
        #self.fields['billing_year_month'].widget.attrs['id'] = 'data'
        #self.fields['billing_year_month'].widget.attrs['style'] = 'width:150px; height:40px;'
        #self.fields['name'].widget.attrs['style'] = 'width:450px; height:40px;'
